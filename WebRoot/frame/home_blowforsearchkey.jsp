...
<td align="right">
   ...
   <s:if test="#session.pageBean.currPage > 1">
       <a href="<%=basePath %>product_searchKey.action?currPage=1&searchkey=${sessionScope.searchkey }">[首页]</a>&nbsp;&nbsp;
       <a href="<%=basePath %>product_searchKey.action?currPage=<s:property value="#session.pageBean.currPage-1" />&searchkey=${sessionScope.searchkey }">[上一页]</a>&nbsp;&nbsp;
   </s:if>
   <s:if test="#session.pageBean.currPage < #session.pageBean.totalPage">
       <a href="<%=basePath %>product_searchKey.action?currPage=<s:property value="#session.pageBean.currPage+1" />&searchkey=${sessionScope.searchkey }">[下一页]</a>&nbsp;&nbsp;
       <a href="<%=basePath %>product_searchKey.action?currPage=<s:property value="#session.pageBean.totalPage" />&searchkey=${sessionScope.searchkey }">[尾页]</a>&nbsp;&nbsp;
   </s:if>
   </span>
</td>
</tr>
